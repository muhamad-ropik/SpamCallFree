...
class prankcall{
	...
	public function run(){
		while(true){
			echo "root@MR.R021=# Kirim Mode Manual/Tidak ?(y/t) : ";
			$loop = $this->get();
			if($loop=="y" OR $loop=="t"){
				break;
			}else{
		...
		if($loop=="y"){
			echo "root@MR.R021=# Masukan Jumlah Spam #-> ";
			$many = $this->get();
			$this->loop($many);
		}else{
			$this->ekse();
...
echo $red."
[!] Author   : MR.R021		            [!]
[!] Youtube  : MR.R021 Tutorial             [!]
[!] github   : github.com/Muhamad-Ropik     [!]\n";
echo $green."
======================================
|[!]  Thanks To Dark Cyber Army   [!]|
======================================\n";
echo "\n";
echo "\n";
echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n";
echo "@ [!]  Contoh : 0882***** / 62882******  [!] @\n";
echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n";
echo " \n";
echo " \n";
sleep ('0.4');
echo "root@MR.R021=# Masukan No Hp Target #-> ";
$no = get();
$n = new prankCall($no);
$n->run();
